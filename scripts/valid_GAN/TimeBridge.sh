...
OUT_ROOT=/mnt/tidalfs-bdsz01/dataset/llm_dataset/plc_data/GanDF
EXP_NAME=finetune
seed=2023
des='TimeBridge'
...
alpha_list=(0.1 0.3)
view_lambda_list=(0.5)
lr_list=(0.0005 0.0002 0.001)
gan_lr_list=(0.0005 0.0002 0.0001)
ind_discr_list=(0 1)
gan_loss_list=(bce)
gan_optim_list=(adam)
use_amp_list=(0)
lradj_list=(type1 cosine)
bs_list=(32 64)
# NOTE: ETTh1 settings
...
for view_lambda in ${view_lambda_list[@]}; do
...
for gan_lr in ${gan_lr_list[@]}; do
for gan_loss in ${gan_loss_list[@]}; do
for gan_optim in ${gan_optim_list[@]}; do
for use_amp in ${use_amp_list[@]}; do
for ind_discr in ${ind_discr_list[@]}; do
for pl in ${pl_list[@]}; do
    ...
    JOB_NAME=${model_name}_${dst}_${pl}_${rl}_${ax}_${lr}_${lradj}_${train_epochs}_${patience}_${batch_size}_${view_lambda}_${normalize}_${gan_lr}_${gan_loss}_${ind_discr}_${step_size}_${gan_optim}_${use_amp}
    ...
    echo "Running command for $JOB_NAME"
    {
        ...
        CUDA_VISIBLE_DEVICES=$gpu_allocation python -u run.py \
            --task_name long_term_forecast_gan \
            --is_training 1 \
            ...
            --rec_lambda ${rl} \
            --auxi_lambda ${ax} \
            --view_lambda ${view_lambda} \
            --normalize ${normalize} \
            --meta_lr ${gan_lr} \
            --meta_loss ${gan_loss} \
            --meta_optim_type ${gan_optim} \
            --ind_discr ${ind_discr} \
            --step_size ${step_size} \
            --fix_seed ${seed} \
