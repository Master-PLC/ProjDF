...
for pl in ${pl_list[@]}; do
    ...
    JOB_NAME=${model_name}_${dst}_${pl}_${rl}_${ax}_${lr}_${lradj}_${train_epochs}_${patience}_${batch_size}_${auxi_batch_size}_${normalize}_${reg_sk}_${auxi_loss}_${mask_factor}_${kernel}_${ot_type}_${joint_forecast}_${auxi_mode}_${lr_inner}_${auxi_type}
    OUTPUT_DIR="./results_KB/${EXP_NAME}/${JOB_NAME}"
    ...
    echo "Running command for $JOB_NAME"
    {
        ...
        CUDA_VISIBLE_DEVICES=$gpu_allocation python -u run.py \
            ...
            --inner_lr $lr_inner \
            --J ${J} \
            --meta_inner_steps ${inner_steps} \
            --meta_optim_type ${meta_optim_type} \
            --auxi_type ${auxi_type}
...
# bs_list=(32)
# auxi_bs_list=(1024)
# reg_sk_list=(0.005 0.0005 0.00005)
...
for pl in ${pl_list[@]}; do
    ...
    JOB_NAME=${model_name}_${dst}_${pl}_${rl}_${ax}_${lr}_${lradj}_${train_epochs}_${patience}_${batch_size}_${auxi_batch_size}_${normalize}_${reg_sk}_${auxi_loss}_${mask_factor}_${distance}_${ot_type}_${joint_forecast}_${auxi_mode}_${lr_inner}
    OUTPUT_DIR="./results_KB/${EXP_NAME}/${JOB_NAME}"
