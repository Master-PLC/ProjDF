...
for pl in ${pl_list[@]}; do
    ...
    JOB_NAME=${model_name}_${dst}_${pl}_${rl}_${ax}_${lr}_${lr_inner}_${lr_meta}_${lradj}_${train_epochs}_${patience}_${batch_size}_${auxi_batch_size}_${reg_lambda}_${max_norm}_${num_tasks}_${overlap_ratio}_${meta_inner_steps}_${fixed_step}_${auxi_loss}_${cycle}_${dropout}_${model_type}_${use_revin}_${first_order}
