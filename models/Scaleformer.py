...
#####################################################################################
# Code is based on the Scaleformer implementation
# from https://github.com/BorealisAI/scaleformer/blob/main/models/FEDformerMS.py
####################################################################################

import torch
import torch.nn as nn
from layers.Embed import DataEmbedding_scale
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.enc_embedding = DataEmbedding_scale(configs.enc_in, configs.d_model, configs.embed, configs.freq, configs.dropout)
        self.dec_embedding = DataEmbedding_scale(configs.dec_in, configs.d_model, configs.embed, configs.freq, configs.dropout, is_decoder=True)
